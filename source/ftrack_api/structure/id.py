        ...
        if entity.entity_type in ("FileComponent",):
            ...
            if container and container is not ftrack_api.symbol.NOT_SET:
                ...
                if container.entity_type in ("SequenceComponent",):
                    ...
                    name = "file.{0}{1}".format(entity["name"], entity["file_type"])
            ...
            parts = [self.prefix] + list(entity["id"][:4]) + [entity["id"][4:]] + [name]
            ...
            raise NotImplementedError(
                "Cannot generate path for unsupported " "entity {0}".format(entity)
            )
