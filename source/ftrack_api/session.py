...
class Session(object):
    ...
    def _configure_locations(self):
        ...
        location = self.create(
            'Location',
            data=dict(
                name='ftrack.origin', id=ftrack_api.symbol.ORIGIN_LOCATION_ID
            ),
            reconstructing=True,
        )
        ftrack_api.mixin(
        ...
        location = self.create(
            'Location',
            data=dict(
                name='ftrack.review', id=ftrack_api.symbol.REVIEW_LOCATION_ID
            ),
            reconstructing=True,
        )
        ftrack_api.mixin(
        ...
        location = self.create(
            'Location',
            data=dict(
                name='ftrack.server', id=ftrack_api.symbol.SERVER_LOCATION_ID
            ),
            reconstructing=True,
        )
        ftrack_api.mixin(
