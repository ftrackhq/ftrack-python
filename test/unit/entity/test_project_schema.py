...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param('Shot', ['Normal', 'Omitted', 'On Hold'], id='shot'),
        pytest.param('AssetVersion', ['Approved', 'Pending'], id='asset version'),
        pytest.param('AssetBuild', ['Normal', 'Omitted', 'On Hold'], id='asset_build'),
