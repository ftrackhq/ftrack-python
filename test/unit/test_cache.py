...
@pytest.mark.parametrize('items, key', [
    ...
    (
        ...
        b'\x02\x80\x04\x95\x05\x00\x00\x00\x00\x00\x00\x00\x8c\x01b\x94.'
        b'\x01\x00\x03\x80\x04\x95\x03\x00\x00\x00\x00\x00\x00\x00K\x01.'
        b'\x00\x80\x04\x95\x03\x00\x00\x00\x00\x00\x00\x00K\x02.\x03'
    ),
    (
        (function,),
        b'\x04function\x00unit.test_cache'
