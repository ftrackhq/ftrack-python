...
class EventHub:
    ...
    id: Incomplete
    server: Incomplete
    def __init__(self, server_url, api_user, api_key, headers: Incomplete | None = None, cookies: Incomplete | None = None) -> None: ...
    ...
    def subscribe(self, subscription, callback, subscriber: Incomplete | None = None, priority: int = 100): ...
    def unsubscribe(self, subscriber_identifier) -> None: ...
    def publish(self, event, synchronous: bool = False, on_reply: Incomplete | None = None, on_error: str = 'raise'): ...
    def publish_reply(self, source_event, data, source: Incomplete | None = None) -> None: ...
    def subscription(self, subscription, callback, subscriber: Incomplete | None = None, priority: int = 100): ...
